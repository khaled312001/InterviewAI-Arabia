...
//
// This endpoint is now the FALLBACK only: the app voices the interviewer with
// the browser's own neural voices (`window.speechSynthesis`) and reaches for
// this route solely when the browser exposes no usable voice for the interview
// language. See mobile/src/speech/webSpeech.ts.
//
