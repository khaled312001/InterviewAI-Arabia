 ...
 *
 * Metro resolves `./camera` to `camera.web.*` on web and `camera.native.*` on device,
 * so this file is never bundled. TypeScript has no concept of platform
 * extensions, so without it `./camera` would not resolve at all. Pointing it at
