 ...
 *
 * Metro resolves `./speech` to `speech.web.*` on web and `speech.native.*` on device,
 * so this file is never bundled. TypeScript has no concept of platform
 * extensions, so without it `./speech` would not resolve at all. Pointing it at
