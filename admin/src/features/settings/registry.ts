    ...
    settings: [
      ...
      },
      {
        ...
        help:
          ...
          + 'SHA-1 لمفتاح التوقيع. عميل واحد = بصمة واحدة، ومفتاح الرفع ومفتاح Play للتوقيع '
          + 'مختلفان — فالنسخة المنشورة والنسخة المحلية تحتاج كل منهما عميلًا مستقلًا. '
          + 'اكتب المُعرّفين هنا مفصولين بفاصلة: التطبيق يبدأ الدخول بالأول، والخادم يقبل '
          + 'التوكن من أيٍّ منهما. مُعرّف واحد فقط يعني نجاح الدخول في إحدى النسختين وفشله في الأخرى.',
        type: 'text',
        defaultValue: '',
        effect: 'live',
      },
